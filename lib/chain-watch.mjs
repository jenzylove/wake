...
export const WATCHED = {
  "1": {
    ...
    fallbacks: ["https://eth.llamarpc.com", "https://rpc.ankr.com/eth"],
    blockSeconds: 12,
    tokens: {
  ...
  "42161": {
    ...
    fallbacks: ["https://arbitrum.publicnode.com", "https://arb1.croswap.com/rpc"],
    blockSeconds: 0.25,
    tokens: {
 ...
 */
export async function confirmDrain({ url, transfer, fallbacks = [] }) {
