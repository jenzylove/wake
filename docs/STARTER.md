# Starter scaffolding notes

WAKE is built on the vinext starter. These are the scaffolding notes that came
with it, kept here so the project README can be about WAKE. Nothing below is
specific to WAKE and most of it is not exercised by this build.
