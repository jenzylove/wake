 ...
 */
export function evaluate(row, { equityUsd, openSymbols, openCount, now }) {
  ...
  const notionalUsd = (equityUsd * CONFIG.riskPerTradeRate) / CONFIG.stopRate
  ...
  return {
    ...
    order: {
      ...
      size,
      notionalUsd,
      stopPrice: side === "SHORT" ? entryPrice * (1 + CONFIG.stopRate) : entryPrice * (1 - CONFIG.stopRate),
