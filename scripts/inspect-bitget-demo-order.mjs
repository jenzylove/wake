...
async function request(method, requestPath) {
  ...
  return new Promise((resolve, reject) => {
    const req = https.request({ hostname: process.env.BITGET_API_IP?.trim() || "api.bitget.com", port: 443, servername: "api.bitget.com", path: requestPath, method, headers: { Host: "api.bitget.com", "Content-Type": "application/json", locale: "en-US", "ACCESS-KEY": apiKey, "ACCESS-SIGN": signature, "ACCESS-TIMESTAMP": timestamp, "ACCESS-PASSPHRASE": passphrase, paptrading: "1" } }, (response) => {
      let text = ""
